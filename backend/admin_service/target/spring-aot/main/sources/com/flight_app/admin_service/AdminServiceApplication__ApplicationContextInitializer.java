 ...
 */
@Generated
public class AdminServiceApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new AdminServiceApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new AdminServiceApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
